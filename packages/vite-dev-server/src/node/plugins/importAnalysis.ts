...
import type { StaticImport } from '../../shared/utils'
import { ESM_STATIC_IMPORT_RE, parseStaticImport } from '../../shared/utils'
// NOTE(kazupon): commented out, because avoid to conflict node:url of mlly
    ...
    for (const spec of node.specifiers) {
      if (spec.type === 'ImportSpecifier') {
        ...
        if (exportedName === 'default') {
          ...
          const localName = `__vite__cjsExport${spec.exported.type === 'Literal'
