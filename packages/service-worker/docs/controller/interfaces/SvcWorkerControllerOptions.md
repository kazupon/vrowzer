...
| <a id="scripturl"></a> `scriptURL`            | `string` \| `URL`             | The URL of the service worker script to register. **See** https://developer.mozilla.org/en-US/docs/Web/API/ServiceWorkerContainer/register | -                                    |
