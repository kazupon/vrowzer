...
[@vrowzer/service-worker](../index.md) / admin

# admin

Service Worker Administration API

Provides management functions for service workers registered via [SvcWorkerController](../controller/interfaces/SvcWorkerController.md).
