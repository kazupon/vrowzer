...
import { slash } from '../shared/utils.ts'
import { arraify } from '../utils'

import type { ModuleTypeFilter } from '@rolldown/browser'
...
function patternToIdFilter(pattern: string | RegExp, cwd: string): PluginFilter {
...
function createModuleTypeFilter(filter: ModuleTypeFilter | undefined): PluginFilter | undefined {
  if (!filter) return
