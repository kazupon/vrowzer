...
// NOTE(kazupon): use vite's json plugin from 'vite:json'
// import { viteJsonPlugin as nativeJsonPlugin } from 'rolldown/experimental'
import { SPECIAL_QUERY_RE } from '../constants.ts'
import { stripBomTag } from '../utils.ts'
import { inlineRE, noInlineRE } from './asset.ts'
...
export const isJSONRequest = (request: string): boolean => jsonLangRE.test(request)
...
export function jsonPlugin(
  ...
  // NOTE(kazupon): Native plugin is disabled
...
function serializeValue(value: unknown): string {
  ...
  // https://v8.dev/blog/cost-of-javascript-2019#:~:text=A%20good%20rule%20of%20thumb%20is%20to%20apply%20this%20technique%20for%20objects%20of%2010%20kB%20or%20larger
  if (typeof value === 'object' && value != null && valueAsString.length > 10 * 1000) {
